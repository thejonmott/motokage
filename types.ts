...
declare global {
  ...
  interface Window {
    // FIX: Removed readonly modifier to fix the "identical modifiers" error during interface merging.
    // The environment-provided global declaration of aistudio on Window may not consistently use readonly.
    aistudio: AIStudio;
  }
}

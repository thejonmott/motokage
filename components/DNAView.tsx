  ...
  return (
    <div className="space-y-12 max-w-5xl mx-auto">
      ...
      <div className="bg-indigo-600/5 border border-indigo-500/20 p-12 rounded-[3.5rem] text-center space-y-6">
        ...
        <p className="text-slate-500 font-mono text-xs max-w-2xl mx-auto uppercase leading-relaxed tracking-wider">
          These core values define the alignment for every agent and every response generated by "The Self".
        </p>
